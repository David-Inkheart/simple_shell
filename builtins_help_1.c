...
/**
 * help_all - Displays all possible builtin unixhell commands.
 */
void help_all(void)
{
...
/**
 * help_alias - Displays information on the unixhell builtin command 'alias'.
 */
void help_alias(void)
{
...
/**
 * help_cd - Displays information on the unixhell builtin command 'cd'.
 */
void help_cd(void)
{
...
/**
 * help_exit - Displays information on the unixhell builtin command 'exit'.
 */
void help_exit(void)
{
...
/**
 * help_help - Displays information on the unixhell builtin command 'help'.
 */
void help_help(void)
{
	char *msg = "help: help\n\tSee all possible unixhell builtin commands.\n";
